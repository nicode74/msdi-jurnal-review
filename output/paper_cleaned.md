...
2. [Metode](#metode)
3. [Tema Penelitian Utama](#tema-penelitian-utama)
4. [Daya Pendorong Optimisasi DCN: Tantangan di Antara Tema Utama](#daya-pendorong-optimisasi-dcn-tantangan-di-antara-tema-utama)
5. [Konsep Dasar dan Kemajuan Utama dalam DCN](#konsep-dasar-dan-kemajuan-utama-dalam-dcn)
6. [Analisis Perbandingan Antara Teknik Jaringan Tradisional dan Berbasis AI](#analisis-perbandingan-antara-teknik-jaringan-tradisional-dan-berbasis-ai)
7. [Tantangan dalam Menerapkan AI/ML untuk Optimisasi dan Manajemen DCN](#tantangan-dalam-menerapkan-aiml-untuk-optimisasi-dan-manajemen-dcn)
8. [Diskusi](#diskusi)
9. [Tren Masa Depan dalam Penelitian DCN](#tren-masa-depan-dalam-penelitian-dcn)
10. [Kesimpulan](#kesimpulan)
11. [Apendiks](#apendiks)
...
- **Kontrol Kemacetan & Manajemen Lalu Lintas:** Pertumbuhan eksponensial lalu lintas data dalam DCN menjadikan kontrol kemacetan dan manajemen lalu lintas topik penting untuk dipelajai. Beberapa survei memberikan diskusi komprehensif tentang algoritma kontrol kemacetan, teknik manajemen aliran jaringan, dan implementasinya secara praktis. Survei-survei ini membandingkan metode tradisional dengan solusi berbasis AI yang muncul, menekankan dampaknya dalam meningkatkan throughput data dan mengurangi kehilangan paket.
...
## 4. DAYA PENDORONG OPTIMISASI DCN: TANTANGAN DI ANTARA TEMA UTAMA
...
## 5. KONSEP DASAR DAN KEMAJUAN UTAMA DALAM DCN
...
## 6. PRINSIP JARINGAN INTI DALAM DCN
...
## 7. ANALISIS PERBANDINGAN ANTARA TEKNIK JARINGAN TRADISIONAL DAN BERBASIS AI
...
Lebih lanjut, model ML seperti Artificial Neural Networks (ANN), Graph Neural Networks (GNN), dan Support Vector Machines (SVM) telah digunakan untuk menganalisis pola lalu lintas historis dan memprediksi lonjkan lalu lintas, memungkinkan alokasi sumber daya proaktif [175]. Selain itu, arsitektur deep learning seperti Residual Networks (ResNet) memungkinkan sistem berbasis AI memperkirakan okupansi tautan jaringan secara waktu nyata, meningkatkan keputusan routing dan efisiensi keseluruhan [176].
...
## 8. TANTANGAN DALAM MENERAPKAN AI/ML UNTUK OPTIMISASI DAN MANAJEMEN DCN
...
## 10. TREN MASA DEPAN DALAM PENELITIAN DCN
...
[12] X.L. Wei, M. Chen, J.-H. Fan, G.-M. Zhang, dan Z.-Y. Lu, "Architecture of the data center network: Architecture of the data center network," J. Softw., vol. 24, no. 2, pp. 295-316, Dec. 2013.

[13] N. Farrington dan A. Andreyev, "Facebook's data center network architecture," in Proc. Opt. Interconnects Conf., May 2013, pp. 49-50.

[14] J. Zhang, F. Ren, dan C. Lin, "Survey on transport control in data center networks," IEEE Netw., vol. 27, no. 4, pp. 22-26, Jul. 2013.

[15] J. Perelló et al., "All-optical packet/circuit switching-based data center network for enhanced scalability, latency, and throughput," IEEE Netw., vol. 27, no. 6, pp. 14-22, Nov. 2013.

[16] C. Kachris dan I. Tomkos, "Power consumption evaluation of all-optical data center networks," Cluster Comput., vol. 16, no. 3, pp. 611-623, Aug. 2012.

[17] K. Bilal, S. U. Khan, dan A. Y. Zomaya, "Green data center networks: Challenges and opportunities," in Proc. 11th Int. Conf. Frontiers Inf. Technol., Dec. 2013, pp. 229-234.

[18] P.P. Jiang, C.Q. Yu, dan Y. H. Peng, "Energy-saving in optical data center networks," Appl. Mech. Mater., vols. 411-414, pp. 634-637, Sep. 2013.

[19] M. F. Bari, R. Boutaba, R. Esteves, L. Z. Granville, M. Podlesny, M. G. Rabbani, Q. Zhang, dan M. F. Zhani, "Data center network virtualization: A survey," IEEE Commun. Surveys Tuts., vol. 15, no. 2, pp. 909-928, 2nd Quart., 2013.

[20] Y. Cai, Y. Yan, Z. Zhang, dan Y. Yang, "Survey on converged data center networks with DCB and FCoE: Standards and protocols." IEEE Netw., vol. 27, no. 4, pp. 27-32, Jul. 2013.

[21] A. Hendel, "Large-scale data center networks," in Proc. Commun. Conf., 2014, pp. Th4J.1- Th4J.1.

[22] F. Yao, J. Wu, G. Venkataramani, dan S. Subramaniam, "A comparative analysis of data center network architectures," in Proc. IEEE Int. Conf. Commun. (ICC), Jun. 2014, pp. 3106-3111.

[23] Y. Ren, Y. Zhao, P. Liu, K. Dou, dan J. Li, "A survey on TCP incast in data center networks," Int. J. Commun. Syst., vol. 27, no. 8, pp. 1160-1172, Jul. 2012.

[24] H. X. Wu, X. L. Yang, dan M. Zhang, "Optically interconnected data center networks: A survey and new perspectives," in Proc. Opt. Fiber Commun. Conf., vols. 462-463, pp. 1028-1035, Nov. 2013.

[25] K. Kitayama, Y.-C. Huang, Y. Yoshida, R. Takahashi, dan M. Hayashitani, "Optical packet and path switching intra-data center network: Enabling technologies and network performance with intelligent flow control," in Proc. Eur. Conf. Opt. Commun. (ECOC), Sep. 2014, pp. 1-3.

[26] M. Fayyaz dan K. Aziz, "Classification of optical interconnects in data center networks," in Proc. 12th Int. Conf. Frontiers Inf. Technol., Dec. 2014, pp. 61-66.

[27] N. Calabretta, W. Miao, S. D. Lucente, J. Luo, dan H. J. S. Dorren, "Scalable and low latency optical packet switching architectures for high performance data center networks," in Adv. Photon. Commun., 2014.

[28] K. Kitayama, Y. Huang, Y. Yoshida, R. Takahashi, dan M. Hayashitani, "OPS/OCS intra-data center network with intelligent flow control," in Adv. Photon. Commun., 2014.

[29] H. Qi, M. Shiraz, J.-Y. Liu, A. Gani, Z. A. Rahman, dan T. A. Altameem, "Data center network architecture in cloud computing: Review, taxonomy, and open research issues," J. Zhejiang Univ. Sci. C, vol. 15, no. 9, pp. 776-793, Sep. 2014.

[30] A. Hammadi dan L. Mhamdi, "A survey on architectures and energy efficiency in data center networks," Comput. Commun., vol. 40, pp. 1-21, Mar. 2014.

[31] K. Bilal, S. U. R. Malik, O. Khalid, A. Hameed, E. Alvarez, V. Wijaysekara, R. Irfan, S. Shrestha, D. Dwivedy, M. Ali, U. S. Khan, A. Abbas, N. Jalil, dan S. U. Khan, "A taxonomy and survey on green data center networks." Future Gener. Comput. Syst., vol. 36, pp. 189-208, Jul. 2014.

[32] B. Maggs, "A universal approach to data center network design," in Proc. 26th ACM Symp. Parallelism Algorithms Archit., Jun. 2014, p. 246.

[33] A. Lonare dan V. Gulhane, "Addressing agility and load balance in fat-tree data center network—A review," in Proc. 2nd Int. Conf. Electron. Commun. Syst. (ICECS), Feb. 2015, pp. 965-971.

[34] M. Fayyaz, K. Aziz, dan G. Mujtaba, "Blocking probability in optical interconnects in data center networks," Photonic Netw. Commun., vol. 30, no. 2, pp. 204-222, May 2015.

[35] W. Hou, L. Guo, Y. Liu, C. Yu, dan Y. Zong, "Resource management and control in converged optical data center networks: Survey and enabling technologies," Comput. Netw., vol. 88, pp. 121-135, Sep. 2015.

[36] R. Takahashi, T. Segawa, S. Ibrahim, T. Nakahara, H. Ishikawa, A. Hiramatsu, Y.-C. Huang, dan K.-i. Kitayama, "Torus data center network with smart flow control enabled by hybrid optoelectronic routers [Invited]," J. Opt. Commun. Netw., vol. 7, no. 12, pp. B141-B152, Dec. 2015.

[37] C. Kachris dan I. Tomkos, "A roadmap on optical interconnects in data centre networks," in Proc. 17th Int. Conf. Transparent Opt. Netw. (ICTON), Jul. 2015, pp. 1-3.

[38] K.-I. Kitayama, Y.-C. Huang, Y. Yoshida, R. Takahashi, T. Segawa, S. Ibrahim, T. Nakahara, Y. Suzaki, M. Hayashitani, Y. Hasegawa, Y. Mizukoshi, dan A. Hiramatsu, "Torus-topology data center network based on optical packet/agile circuit switching with intelligent flow management," J. Lightw. Technol., vol. 33, no. 5, pp. 1063-1071, Mar. 2015.

[39] R. Rojas-Cessa, Y. Kaymak, dan Z. Dong, "Schemes for fast transmission of flows in data center networks," IEEE Commun. Surveys Tuts., vol. 17, ...
